...
(function(CS) {
    ...
    var myCustomSymbolDefinition = {
        ...
        typeName: '2Valor_MTD_Dif',
        displayName: 'Diferencia, 2 Valores | (MTD)',
    ...
    symbolVis.prototype.init = function(scope, elem, timeProvider, $interval) {
        ...
        function myCustomConfigurationChangeFunction(data) {
            if (chart) {
                ...
                // if (chart.graphs[1].negativeLineColor !== scope.config.negativeLineColor) {
                //     chart.graphs[1].negativeLineColor = scope.config.negativeLineColor;
                // }
                // if (chart.graphs[1].negativeFillColors !== scope.config.negativeFillColors) {
                //     chart.graphs[1].negativeFillColors = scope.config.negativeFillColors;
                // }
                ...
                //Graph 3
                if (chart.graphs[2].negativeLineColor !== scope.config.negativeLineColor) {
                    chart.graphs[2].negativeLineColor = scope.config.negativeLineColor;
                }
                if (chart.graphs[2].negativeFillColors !== scope.config.negativeFillColors) {
                    chart.graphs[2].negativeFillColors = scope.config.negativeFillColors;
                }

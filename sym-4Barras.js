    ...
    symbolVis.prototype.init = function(scope, elem) {
        ...
        function myCustomDataUpdateFunction(data) {
            ...
            if (data !== null && data.Data) {
                ...
                if (data.Data[3].Label) {
                    var label4 = data.Data[3].Label;
                    var posicion4 = label3.indexOf('|');
                    label4 = label4.substr(posicion4 + 1, label4.length);
                }
                // if (data.Data[3].Units) {
                //     var stringUnits4 = data.Data[3].Units;
                // }
                ...
                for (var i = 0; i < data.Data[0].Values.length; i++) {
                    ...
                    let valor3 = data.Data[2].Values.length > 0 ?
                        parseFloat(("" + data.Data[2].Values[i].Value).replace(",", ".")).toFixed(scope.config.decimalPlaces) : 0;
                    let valor4 = data.Data[3].Values.length > 0 ?
                        parseFloat(("" + data.Data[3].Values[i].Value).replace(",", ".")).toFixed(scope.config.decimalPlaces) : 0;
                    ...
                    chart = AmCharts.makeChart(symbolContainerDiv.id, {
                        ...
                        "graphs": [{
                            ...
                            },
                            {
                                ...
                                "ballonText": scope.config.enabledCursor ? (
                                    "[[category]]<br><b><span style='font-size:14px;'>value:[[value4]]</span></b>"
                                ) : "",
                                "lineColor": scope.config.barColor4,
                                "title": label4,
                                "type": "column",
                                "labelText": "[[value4]]",
                                "showAllValueLabels": scope.config.showAllValueLabels,
        ...
        function myCustomConfigurationChangeFunction(data) {
            ...
            if (chart) {
                ...
                if (chart.graphs[3].fillColors !== scope.config.barColor4) {
                    chart.graphs[3].fillColors = scope.config.barColor4;
                }
